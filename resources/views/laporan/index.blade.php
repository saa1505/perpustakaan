<x-app-layout>
    <style>
        ...
        @media screen {
            .container-print {
                display: none;
                /* Sembunyikan versi print di layar */
            }
        }
        ...
        @media print {
            ...
            .container-print {
                ...
                /* LEBIH RAMPING: Sesuaikan ke 140mm jika masih kurang kecil */
                margin: 0 auto;
        ...
        <div class="bg-white/70 backdrop-blur-xl px-6 py-5 rounded-3xl shadow-lg border border-white/20">
            <div class="flex justify-between items-center mb-6">
                <div class="flex gap-3">
                    <a href="{{ route('laporan.print') }}" target="_blank" class="btn btn-danger">
                        Export PDF
                    </a>
                </div>
                        ...
                        @foreach ($transactions as $t)
                            <tr class="hover:bg-indigo-50/50 transition">
                                ...
                                <td class="p-4 text-center">
                                    <span
                                        class="px-3 py-1 rounded-full text-xs font-semibold {{ $t->status == 'kembali' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700' }}">
                                        {{ strtoupper($t->status) }}
                                    </span>
                                </td>
